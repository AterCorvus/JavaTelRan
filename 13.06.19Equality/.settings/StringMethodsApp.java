...
public class StringMethodsApp {
	...
	public static void main(String[] args) {	
		...
		System.out.println(countOccuran(str, "a"));
		int[] posOccur = getOccuran(str, "a");
		int posOccurLen = posOccur.length;
		for (int i = 0; i < posOccurLen; i++) {
			System.out.println(posOccur[i]);
		}
	}
